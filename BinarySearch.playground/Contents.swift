...
//}
//
//private func isPossible(capacity: Int) -> Bool {
//    
//   return true
//    
//    
...
func peakIndexInMountainArray(_ arr: [Int]) -> Int {
    ...
    while start <= end {
        ...
        if (mid - 1 > start && mid + 1 < end), (arr[mid] > arr[mid - 1] && arr[mid] > arr[mid + 1]) {
            return mid
...
let sarr = [1, 10, 1]
print(peakIndexInMountainArray(sarr))
